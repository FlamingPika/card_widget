...
function change_image() {
    ...
    const content_list = ['Daughter of Discs', '8 of Cups', 'Daughter of Wands', '9 of Swords', '9 of Wands', 'Son of Wands', '8 of Wands', '8 of Swords', '9 of Cups', 'Shaman of Swords', '9 of Discs', '10 of Wands', 'Priestess of Discs', '8 of Discs', '10 of Cups', 'Priestess of Cups', 'Ace of Wands', 'Priestess of Swords', 'Priestess of Wands', '3 of Discs', 'Shaman of Cups', 'Ace of Cups', '2 of Discs', 'Daughter of Swords', '6 of Discs', 'Shaman of Wands', 'Ace of Swords', '7 of Discs', '5 of Discs', 'Son of Discs', '10 of Discs', '4 of Discs', '7 of Cups', 'Son of Cups', '6 of Swords', '10 of Swords', '6 of Wands', '7 of Wands', 'Daughter of Cups', '7 of Swords', '6 of Cups', '4 of Cups', '5 of Swords', '5 of Wands', '4 of Wands', '4 of Swords', '5 of Cups', 'Shaman of Discs', 'Ace of Discs', '2 of Cups', '3 of Swords', '3 of Wands', '2 of Wands', 'Son of Swords', '2 of Swords', '3 of Cups'];
    let chosen_index = []; 
    let iter = 0;
    ...
    image.forEach(img => {
        ...
        text_content[iter].innerHTML = `<h2 class='title-font' style='font-size: 20px;'>${content_list[random]}</h2>`;
